 ...
 * @LastEditTime: 2022-08-09 11:56:18
      ...
      child: Material(
        child: Ink(
          decoration: BoxDecoration(
            ...
            color: model.isChoice ? TWColors.twFF8000 : TWColors.twF5F5F5,
          ),
          child: InkWell(
            highlightColor: TWColors.twFF8000,
            onTap: () {
              if (onTap != null) {
                onTap!(index, model);
              }
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 14.sp,
                    color:
                        model.isChoice ? TWColors.twFFFFFF : TWColors.tw666666,
                  ),
                ),
              ],
            ),
